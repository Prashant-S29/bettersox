...
// icons
import { PlusIcon, SettingsIcon, LogOut } from "lucide-react";
            ...
            <SidebarMenu>
              {NavItems.map((item, index) => (
                <SidebarMenuItem key={index}>
                  ...
                  {!item.enabled && (
                    <SidebarMenuBadge className="bg-sidebar-accent px-2">
                      Coming Soon
                    </SidebarMenuBadge>
                  )}
      ...
      <SidebarFooter className="border-sidebar-border border-t">
        <SidebarMenu>
          <SidebarMenuItem className="p-2">
            <div className="bg-sidebar-accent flex w-full flex-col gap-5 rounded-lg px-3 py-2 pb-3">
              <p className="font-flagfies text-muted-foreground text-2xl leading-tight">
                DON&apos;T <br />
                CONTRIBUTE
                <br />
                TO OPEN - <br />
          ...
          <SidebarMenuItem className="flex gap-2 px-2">
